    ...
    class Program
    {
        ...
        private static async Task InitDbAsync(IoTDbContext db)
        {
            ...
            await db.OPPO_Property.AddRangeAsync(
                ...
                , new OPPO_Property { pid = 201003, type = "uint32", precision = -1,  name1 = "freqSetting", name = "频率控制", description = "Exhaust Fan Frequence Setting" }
                , new OPPO_Property { pid = 201004, type = "uint32", precision = -1,  name1 = "freqFeedback", name = "频率反馈", description = "Exhaust Fan Frequence Feedback" }
                , new OPPO_Property { pid = 201005, type = "uint32", precision = -1,  name1 = "vlvOpening", name = "阀门开度设定", description = "Valve Opening" }
                , new OPPO_Property { pid = 201006, type = "uint32", precision = -1,  name1 = "vlvFeedback", name = "阀门开度反馈", description = "Valve Opening Feedback" }
                ...
                , new OPPO_Property { pid = 201012, type = "uint32", precision = -1,  name1 = "coolingVlvFeedback1", name = "冷水阀开度反馈1", description = "Cooling Valve Opening Feedback" }
                , new OPPO_Property { pid = 201013, type = "uint32", precision = -1,  name1 = "coolingVlvFeedback2", name = "冷水阀开度反馈2", description = "Cooling Valve Opening Feedback" }
                , new OPPO_Property { pid = 201014, type = "uint32", precision = -1,  name1 = "coolingVlvOpening1", name = "冷水阀开度调节1", description = "Cooling Valve Opening" }
                , new OPPO_Property { pid = 201015, type = "uint32", precision = -1,  name1 = "coolingVlvOpening2", name = "冷水阀开度调节2", description = "Cooling Valve Opening" }
                , new OPPO_Property { pid = 201016, type = "uint32", precision = -1,  name1 = "heatingVlvFeedback", name = "热水阀开度调节", description = "Heating Valve Opening Feedback" }
                , new OPPO_Property { pid = 201017, type = "uint32", precision = -1,  name1 = "heatingVlvOpening", name = "热水阀开度反馈", description = "Heating Valve Opening" }
                ...
                , new OPPO_Property { pid = 201023, type = "uint32", precision = -1,  name1 = "elecHeatingTemp1", name = "电加热温度设定1", description = "Electrical Heating temperature" }
                ...
                , new OPPO_Property { pid = 201027, type = "uint32", precision = -1,  name1 = "elecHeatingTemp2", name = "电加热温度设定2", description = "Electrical Heating temperature" }
                ...
                , new OPPO_Property { pid = 201030, type = "uint32", precision = -1,  name1 = "targetCo2", name = "二氧化碳浓度设定", description = "TargetCo2" }
                , new OPPO_Property { pid = 201031, type = "uint32", precision = -1,  name1 = "currentPres1", name = "压力1", description = "Pressure1" }
                , new OPPO_Property { pid = 201032, type = "uint32", precision = -1,  name1 = "currentPres2", name = "压力2", description = "Pressure2" }
                , new OPPO_Property { pid = 201033, type = "uint32", precision = -1,  name1 = "targetPres1", name = "压力设定1", description = "Pressure1setting" }
                , new OPPO_Property { pid = 201034, type = "uint32", precision = -1,  name1 = "targetPres2", name = "压力设定2", description = "Pressure2setting" }
                , new OPPO_Property { pid = 201035, type = "uint32", precision = -1,  name1 = "minimumFreq", name = "频率最小值设定", description = "" }
                , new OPPO_Property { pid = 201036, type = "uint32", precision = -1,  name1 = "maxHumidity", name = "湿度上限设定值", description = "" }
                , new OPPO_Property { pid = 201037, type = "uint32", precision = -1,  name1 = "elecHeatingTempThreshold", name = "电加热报警温度设定值", description = "" }
                , new OPPO_Property { pid = 201038, type = "uint32", precision = -1,  name1 = "minCoolingVlvTemp", name = "冷水阀最小温度设定值1", description = "" }
                , new OPPO_Property { pid = 201039, type = "bool", name1 = "highPresHumidification", name = "高压加湿控制", description = "" }
                , new OPPO_Property { pid = 201040, type = "uint32", precision = -1,  name1 = "humidifierOpeningFeedback", name = "加湿器开度反馈", description = "" }
                , new OPPO_Property { pid = 201041, type = "uint32", precision = -1,  name1 = "humidifierOpening", name = "加湿器开度控制", description = "" }
                , new OPPO_Property { pid = 201042, type = "uint32", precision = -1,  name1 = "currentTemperature3", name = "送风温度3", description = "" }
                , new OPPO_Property { pid = 201043, type = "uint32", precision = -1,  name1 = "maxVlvOpening", name = "阀开度最大值", description = "" }
                , new OPPO_Property { pid = 201044, type = "uint32", precision = -1,  name1 = "airflowRate", name = "实际送风量", description = "" }
                , new OPPO_Property { pid = 201045, type = "uint32", precision = -1,  name1 = "maxAirflowRate", name = "最大风量设定", description = "" }
                ...
                , new OPPO_Property { pid = 201052, type = "uint32", precision = -1,  name1 = "supplyWaterTemp", name = "供水温度", description = "" }
                , new OPPO_Property { pid = 201053, type = "uint32", precision = -1,  name1 = "supplyWaterPres", name = "供水压力", description = "" }
                , new OPPO_Property { pid = 201054, type = "uint32", precision = -1,  name1 = "returnWaterTemp", name = "回水温度", description = "" }
                , new OPPO_Property { pid = 201055, type = "uint32", precision = -1,  name1 = "returnWaterPres", name = "回水压力", description = "" }
                , new OPPO_Property { pid = 201056, type = "uint32", precision = -1,  name1 = "supplyWaterRate", name = "供水流量", description = "" }
                , new OPPO_Property { pid = 201057, type = "uint32", precision = -1,  name1 = "returnWaterRate", name = "回水流量", description = "" }
                , new OPPO_Property { pid = 201058, type = "uint32", precision = -1,  name1 = "targetsupplyWaterTemp", name = "供水温度设定", description = "" }
                , new OPPO_Property { pid = 201059, type = "uint32", precision = -1,  name1 = "iceStorageRate", name = "畜冰槽蓄冰百分比", description = "" }
                , new OPPO_Property { pid = 201060, type = "uint32", precision = -1,  name1 = "iceThickness", name = "畜冰槽蓄冰厚度", description = "" }
                , new OPPO_Property { pid = 201061, type = "uint32", precision = -1,  name1 = "iceStorageCapacity", name = "蓄冰量", description = "" }
                , new OPPO_Property { pid = 201062, type = "uint32", precision = -1,  name1 = "coolingCapacity", name = "冷量", description = "" }
                , new OPPO_Property { pid = 201063, type = "uint32", precision = -1,  name1 = "evaSatPres", name = "主机蒸发器冷媒饱和压力", description = "evaporatorapproachpressure" }
                , new OPPO_Property { pid = 201064, type = "uint32", precision = -1,  name1 = "evaSatTemp", name = "主机蒸发器冷媒饱和温度", description = "" }
                , new OPPO_Property { pid = 201065, type = "uint32", precision = -1,  name1 = "conSatPres", name = "主机冷凝器冷媒饱和压力", description = "" }
                , new OPPO_Property { pid = 201066, type = "uint32", precision = -1,  name1 = "conSatTemp", name = "主机冷凝器冷媒饱和温度", description = "" }
                , new OPPO_Property { pid = 201067, type = "uint32", precision = -1,  name1 = "evaAppTemp", name = "主机蒸发器趋近温度", description = "" }
                , new OPPO_Property { pid = 201068, type = "uint32", precision = -1,  name1 = "conAppTemp", name = "主机冷凝器趋近温度", description = "" }
                ...
                , new OPPO_Property { pid = 201071, type = "uint32", precision = -1,  name1 = "cop", name = "主机COP", description = "" }
                , new OPPO_Property { pid = 201072, type = "uint32", precision = -1,  name1 = "runningLoad", name = "运行负荷", description = "" }
                , new OPPO_Property { pid = 201073, type = "uint32", precision = -1,  name1 = "runningTime", name = "运行时间", description = "" }
                , new OPPO_Property { pid = 201074, type = "uint32", precision = -1,  name1 = "ggOpening1", name = "主机导叶开度1", description = "guideglade" }
                , new OPPO_Property { pid = 201075, type = "uint32", precision = -1,  name1 = "ggOpening2", name = "主机导叶开度2", description = "" }
                , new OPPO_Property { pid = 201076, type = "uint32", precision = -1,  name1 = "ggOpening3", name = "主机导叶开度3", description = "" }
                , new OPPO_Property { pid = 201077, type = "uint32", precision = -1,  name1 = "motorCoilTemp1", name = "主机马达线圈温度1", description = "" }
                , new OPPO_Property { pid = 201078, type = "uint32", precision = -1,  name1 = "motorCoilTemp2", name = "主机马达线圈温度2", description = "" }
                , new OPPO_Property { pid = 201079, type = "uint32", precision = -1,  name1 = "motorCoilTemp3", name = "主机马达线圈温度3", description = "" }
                , new OPPO_Property { pid = 201080, type = "uint32", precision = -1,  name1 = "hVibrationValue", name = "主机横向震动值", description = "" }
                , new OPPO_Property { pid = 201081, type = "uint32", precision = -1,  name1 = "vVibrationValue", name = "主机纵向震动值", description = "" }
                , new OPPO_Property { pid = 201082, type = "uint32", precision = -1,  name1 = "ggOpening1Peer", name = "2#导叶开度", description = "guideglade" }
                , new OPPO_Property { pid = 201083, type = "uint32", precision = -1,  name1 = "ggOpening2Peer", name = "2#导叶开度2", description = "" }
                , new OPPO_Property { pid = 201084, type = "uint32", precision = -1,  name1 = "motorCoilTemp1Peer", name = "2#电机线圈温度", description = "" }
                , new OPPO_Property { pid = 201085, type = "uint32", precision = -1,  name1 = "conAppTempPeer", name = "2#冷凝器趋近温差", description = "" }
                , new OPPO_Property { pid = 201086, type = "uint32", precision = -1,  name1 = "eaTemp", name = "排气温度", description = "" }
                , new OPPO_Property { pid = 201087, type = "uint32", precision = -1,  name1 = "eaTempPeer", name = "2#排气温度", description = "" }
                , new OPPO_Property { pid = 201088, type = "uint32", precision = -1,  name1 = "averageCurrent", name = "平均线电流", description = "" }
                , new OPPO_Property { pid = 201089, type = "uint32", precision = -1,  name1 = "averageCurrentPeer", name = "2#平均线电流", description = "" }
                , new OPPO_Property { pid = 201090, type = "uint32", precision = -1,  name1 = "acOilPressure", name = "压缩机油压力(油压差)", description = "" }
                , new OPPO_Property { pid = 201091, type = "uint32", precision = -1,  name1 = "acOilPressurePeer", name = "2#压缩机油压力(油压差)", description = "" }
                , new OPPO_Property { pid = 201092, type = "uint32", precision = -1,  name1 = "acRunningTime", name = "1#压缩机运行时间", description = "" }
                , new OPPO_Property { pid = 201093, type = "uint32", precision = -1,  name1 = "acRunningTimePeer", name = "2#压缩机运行时间", description = "" }
                , new OPPO_Property { pid = 201094, type = "uint32", precision = -1,  name1 = "oilTemp", name = "1#油温", description = "" }
                , new OPPO_Property { pid = 201095, type = "uint32", precision = -1,  name1 = "oilTempPeer", name = "2#油温", description = "" }
                , new OPPO_Property { pid = 201096, type = "uint32", precision = -1,  name1 = "evaAppTempPeer", name = "2#蒸发器趋近温差", description = "" }
                , new OPPO_Property { pid = 201097, type = "uint32", precision = -1,  name1 = "acStartUpNum", name = "1#主机压缩机启动次数", description = "" }
                , new OPPO_Property { pid = 201098, type = "uint32", precision = -1,  name1 = "acStartUpNumPeer", name = "2#主机压缩机启动次数", description = "" }
                , new OPPO_Property { pid = 201099, type = "uint32", precision = -1,  name1 = "chwSupplyWaterTemp", name = "冷冻出水温度", description = "" }
                , new OPPO_Property { pid = 201100, type = "uint32", precision = -1,  name1 = "chwReturnWaterTemp", name = "冷冻进水温度", description = "" }
                , new OPPO_Property { pid = 201101, type = "uint32", precision = -1,  name1 = "conSatTempPeer", name = "2#冷凝器冷媒温度", description = "" }
                , new OPPO_Property { pid = 201102, type = "uint32", precision = -1,  name1 = "conSatPresPeer", name = "2#冷凝器冷媒压力", description = "" }
                , new OPPO_Property { pid = 201103, type = "uint32", precision = -1,  name1 = "cwSupplyWaterTemp", name = "冷却出水温度", description = "" }
                , new OPPO_Property { pid = 201104, type = "uint32", precision = -1,  name1 = "cwReturnWaterTemp", name = "冷却进水温度", description = "" }
                , new OPPO_Property { pid = 201105, type = "uint32", precision = -1,  name1 = "runningLoadPeer", name = "2#运行电流百分比(冷机负荷)", description = "" }
                , new OPPO_Property { pid = 201106, type = "uint32", precision = -1,  name1 = "evaSatTempPeer", name = "2#蒸发器冷媒温度", description = "" }
                , new OPPO_Property { pid = 201107, type = "uint32", precision = -1,  name1 = "evaSatPresPeer", name = "2#蒸发器冷媒压力", description = "" }
                , new OPPO_Property { pid = 201108, type = "uint32", precision = -1,  name1 = "l1Current", name = "1#主机L1电流", description = "" }
                , new OPPO_Property { pid = 201109, type = "uint32", precision = -1,  name1 = "l1CurrentPeer", name = "2#主机L1电流", description = "" }
                , new OPPO_Property { pid = 201110, type = "uint32", precision = -1,  name1 = "l2Current", name = "1#主机L2电流", description = "" }
                , new OPPO_Property { pid = 201111, type = "uint32", precision = -1,  name1 = "l2CurrentPeer", name = "2#主机L2电流", description = "" }
                , new OPPO_Property { pid = 201112, type = "uint32", precision = -1,  name1 = "l3Current", name = "1#主机L3电流", description = "" }
                , new OPPO_Property { pid = 201113, type = "uint32", precision = -1,  name1 = "l3CurrentPeer", name = "2#主机L3电流", description = "" }
                ...
                , new OPPO_Property { pid = 201116, type = "uint32", precision = -1,  name1 = "autoTurnOnTemp", name = "主机自动启动温差设定值", description = "" }
                , new OPPO_Property { pid = 201117, type = "uint32", precision = -1,  name1 = "autoTurnOffTemp", name = "主机自动停机温差设定值", description = "" }
                , new OPPO_Property { pid = 201118, type = "uint32", precision = -1,  name1 = "cwTargetReturnTemp", name = "冷却水回水温度设定值", description = "" }
                , new OPPO_Property { pid = 201119, type = "uint32", precision = -1,  name1 = "runningPower", name = "1#功率", description = "" }
                , new OPPO_Property { pid = 201120, type = "uint32", precision = -1,  name1 = "runningPowerPeer", name = "2#功率", description = "" }
                , new OPPO_Property { pid = 201121, type = "uint32", precision = -1,  name1 = "chwTargetSupplyTemp", name = "1#出水温度设定点（冷冻供水温度设定）", description = "" }
                , new OPPO_Property { pid = 201122, type = "uint32", precision = -1,  name1 = "chwTargetSupplyTempPeer", name = "2#出水温度设定点（冷冻供水温度设定）", description = "" }
                , new OPPO_Property { pid = 201123, type = "uint32", precision = -1,  name1 = "abVoltage", name = "1#主机AB相电压", description = "" }
                ...
                , new OPPO_Property { pid = 201128, type = "uint32", precision = -1,  name1 = "caVoltagePeer", name = "2#主机CA相电压", description = "" }
                , new OPPO_Property { pid = 201129, type = "uint32", precision = -1,  name1 = "maxRunningLoad", name = "1#最大电流百分比设定（机组负荷设定）", description = "" }
                , new OPPO_Property { pid = 201130, type = "uint32", precision = -1,  name1 = "maxRunningLoadPeer", name = "2#最大电流百分比设定（机组负荷设定）", description = "" }
                , new OPPO_Property { pid = 201131, type = "uint32", precision = -1,  name1 = "oilPumpPres", name = "1#油泵压力", description = "" }
                , new OPPO_Property { pid = 201132, type = "uint32", precision = -1,  name1 = "oilPumpPresPeer", name = "2#油泵压力", description = "" }
                , new OPPO_Property { pid = 201133, type = "uint32", precision = -1,  name1 = "oilTankPres", name = "1#油箱压力", description = "" }
                , new OPPO_Property { pid = 201134, type = "uint32", precision = -1,  name1 = "oilTankPresPeer", name = "2#油箱压力", description = "" }
                , new OPPO_Property { pid = 201135, type = "uint32", precision = -1,  name1 = "coldHeatSourceMode", name = "冷热源系统模式", description = "" }
                , new OPPO_Property { pid = 201136, type = "uint32", precision = -1,  name1 = "currentTemperature2", name = "送风温度2", description = "" }
                ...
                , new OPPO_Property { pid = 200142, type = "int32", precision = -1,  name1 = "currentTemperature", name = "当前温度", description = "Current Temperature" }
                , new OPPO_Property { pid = 200143, type = "int32", precision = -1,  name1 = "targetTemperature", name = "目标温度", description = "Target Temperature" }
                , new OPPO_Property { pid = 200160, type = "uint32", precision = -1,  name1 = "currentHumidity", name = "当前湿度", description = "Current Humidity" }
                , new OPPO_Property { pid = 200161, type = "uint32", precision = -1,  name1 = "targetHumidity", name = "目标湿度", description = "Target Humidity" }
                , new OPPO_Property { pid = 200148, type = "uint32", precision = -1,  name1 = "windSpeed", name = "风速", description = "Wind Speed" }
                , new OPPO_Property { pid = 200153, type = "uint32", precision = -1,  name1 = "co2", name = "二氧化碳", description = "CO2" }
                , new OPPO_Property { pid = 200048, type = "uint32", precision = -1,  name1 = "enthalpy", name = "温湿度焓值", description = "" }
